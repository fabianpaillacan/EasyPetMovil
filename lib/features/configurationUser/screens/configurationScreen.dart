      ...
      body: _isLoading
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  _buildTextField('Nombre', _firstNameController, 'Ej: Diego'),
                  const SizedBox(height: 16),
                  _buildTextField('Apellido Paterno', _lastNameController, 'Ej: Suazo'),
                  const SizedBox(height: 16),
                  _buildTextField('Fecha de Nacimiento', _birthDateController, 'Ej: 10/03/2002'),
                  const SizedBox(height: 16),
                  _buildTextField('Correo Electrónico', _emailController, 'Ej: diego@gmail.com'),
                  const SizedBox(height: 16),
                  _buildTextField('Teléfono', _phoneController, 'Ej: 912345678'),
                  const SizedBox(height: 16),
                  _buildGenderField(),
